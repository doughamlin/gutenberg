...
trait WP_Fonts_Tests_Datasets {
	...
	public function data_font_family_undefined_in_variation() {
		$message = 'The font-family must be a non-empty string.';
		return array(
	...
	public function data_invalid_variation() {
		return array(
			'font-family: undefined'          => array(
				'expected'           => 'The font-family must be a non-empty string.',
				'font_family_handle' => 'lato',
				'variation'          => array(
					'src' => 'https://example.com/assets/fonts/lato.ttf.woff2',
				),
			...
			'src: undefined'                  => array(
				'expected'           => 'The font src must be a non-empty string or an array of strings.',
				'font_family_handle' => 'lato',
				'variation'          => array(
					'provider'    => 'local',
			...
			'font-weight: null'               => array(
				'expected'           => 'The font-weight must be a properly formatted string or integer.',
				'font_family_handle' => 'merriweather',
				'variation'          => array(
					'font-family' => 'Merriweather',
					'font-weight' => null,
