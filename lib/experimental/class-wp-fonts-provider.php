 ...
 *
 * It receives a collection of fonts {@see WP_Fonts_Provider::set_setfonts()},
 * and when requested {@see WP_Fonts_Provider::get_css()}, it transforms
 * them into styles (in a performant way for the provider service
 * it manages).
 *
 * @since X.X.X
 */
abstract class WP_Fonts_Provider {
	 ...
	 *
	 * The API's Controller passes this provider's fonts
