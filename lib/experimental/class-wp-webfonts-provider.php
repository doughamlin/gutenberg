 ...
 *
 * @since X.X.X
 * @deprecated X.X.X Use `WP_Fonts_Provider` instead.
 */
abstract class WP_Webfonts_Provider extends WP_Fonts_Provider {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated X.X.X Use WP_Fonts::$fonts property instead.
	 *
	 * @var array[]
	 */
	 ...
	 *
	 * @since X.X.X
	 * @deprecated X.X.X Use WP_Fonts::set_fonts() instead.
	 *
