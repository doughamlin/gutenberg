...
if ( ! function_exists( 'wp_webfonts' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated X.X.X Use wp_fonts() instead.
	 *
	...
	function wp_webfonts() {
		_deprecated_function( __FUNCTION__, 'X.X.X', 'wp_fonts()' );

		global $wp_webfonts, $wp_fonts;
...
if ( ! function_exists( 'wp_register_webfonts' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated X.X.X Use wp_register_fonts() instead.
	 *
	...
	function wp_register_webfonts( array $webfonts ) {
		_deprecated_function( __FUNCTION__, 'X.X.X', 'wp_register_fonts()' );
...
if ( ! function_exists( 'wp_enqueue_webfonts' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated X.X.X Use wp_enqueue_fonts() instead.
	 *
	 * @param string[] $font_families Font family(ies) to enqueue.
	 */
	function wp_enqueue_webfonts( array $font_families ) {
		_deprecated_function( __FUNCTION__, 'X.X.X', 'wp_enqueue_fonts()' );
...
if ( ! function_exists( 'wp_enqueue_webfont_variations' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated X.X.X Use wp_enqueue_webfont_variations() instead.
	 *
	...
	function wp_enqueue_webfont_variations( $variation_handles ) {
		_deprecated_function( __FUNCTION__, 'X.X.X', 'wp_enqueue_font_variations()' );
...
if ( ! function_exists( 'wp_deregister_webfont_variation' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated X.X.X Use wp_deregister_font_variation() instead.
	 *
	...
	function wp_deregister_webfont_variation( $font_family_handle, $variation_handle ) {
		_deprecated_function( __FUNCTION__, 'X.X.X', 'wp_deregister_font_variation()' );
...
if ( ! function_exists( 'wp_register_webfont_provider' ) ) {
	 ...
	 *
	 * @since 6.0.0
	 * @deprecated X.X.X Use wp_register_font_provider() instead.
	 *
	...
	function wp_register_webfont_provider( $name, $classname ) {
		_deprecated_function( __FUNCTION__, 'X.X.X', 'wp_register_font_provider()' );
