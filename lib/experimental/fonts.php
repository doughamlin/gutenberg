...
if ( ! function_exists( 'wp_register_fonts' ) ) {
	 ...
	 *
	 * @param array[] $fonts {
	 *     Fonts to register, grouped by each font-family.
	 *
	 *     @type string $font-family => array[] $variations {
	 *          An array of font variations for this font-family.
...
if ( ! function_exists( 'wp_register_font_provider' ) ) {
	 ...
	 *
	 * A font provider contains the business logic for how to
	 ...
	 *                          The class should be a child of `WP_Fonts_Provider`.
	 *                          See {@see WP_Fonts_Provider}.
	 *
